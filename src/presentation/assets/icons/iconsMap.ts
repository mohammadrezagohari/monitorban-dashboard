...
export const iconsMap = {
    ...
    dropletPercentIcon: DropletPercentIcon,
    editIcon: EditIcon,
    excelIcon: ExcelIcon,
    eyeIcon: EyeIcon,
    ...
    lightSwitchIcon: LightSwitchIcon,
    listIcon: ListIcon,
    loginIcon: LoginIcon,
    logoIcon: LogoIcon,
    logoText: LogoText,
    ...
    temperatureListIcon: TemperatureListIcon,
    temperatureSnowIcon: TemperatureSnowIcon,
    tickCircleIcon: TickCircleIcon,
    tickIcon: TickIcon,
    twoUsersIcon: TwoUsersIcon,
